...
#ifndef ROSBAG2_TRANSPORT_BACKPORT__GENERIC_SUBSCRIPTION_HPP_
#define ROSBAG2_TRANSPORT_BACKPORT__GENERIC_SUBSCRIPTION_HPP_
...
public:
  ...
  : SubscriptionBase(
      node_base,
      *rosbag2_cpp::get_typesupport_handle(topic_type, "rosidl_typesupport_cpp", ts_lib),
      topic_name,
...
#endif  // ROSBAG2_TRANSPORT_BACKPORT__GENERIC_SUBSCRIPTION_HPP_
